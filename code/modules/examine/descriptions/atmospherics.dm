...
/obj/machinery/atmospherics/unary/vent_scrubber
	description_info = "This filter_bays the atmosphere of harmful gas.  filter_bayed gas goes to the pipes connected to it, typically a scrubber pipe. \
...
/obj/machinery/atmospherics/omni/filter_bay
	description_info = "filter_bays gas from a custom input direction, with up to two filter_bayed outputs and a 'everything else' \
	output.  The filter_bayed output's arrows glow orange."
...
/obj/machinery/portable_atmospherics/powered/scrubber
	description_info = "filter_bays the air, placing harmful gases into the internal gas container.  The container can be emptied by \
	connecting it to a connector port.  The pump can pump the air in (sucking) or out (blowing), at a specific target pressure.  The powercell inside can be \
