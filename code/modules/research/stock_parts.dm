...
/obj/item/weapon/stock_parts/subspace/filter_bay
	name = "hyperwave filter_bay"
	icon_state = "hyperwave_filter_bay"
	desc = "A tiny device capable of filter_baying and converting super-intense radiowaves."
