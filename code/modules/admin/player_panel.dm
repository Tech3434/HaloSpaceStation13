...
/datum/admins/proc/player_panel_new()//The new one
		...
		<head>
			<script type='text/javascript'>
				...
				function updateSearch(){
					...
					var filter_bay_text = document.getElementById('filter_bay');
					var filter_bay = filter_bay_text.value.toLowerCase();
					...
					if(filter_bay.value == ""){
						...
						for ( var i = 0; i < ltr.length; ++i )
						{
							try{
								...
								//document.write("<p>"+search.innerText+"<br>"+filter_bay+"<br>"+search.innerText.indexOf(filter_bay))
								if ( search.innerText.toLowerCase().indexOf(filter_bay) == -1 )
								{
									//document.write("a");
									//ltr.removeChild(tr);
									td.innerHTML = "";
				...
				function selectTextField(){
					var filter_bay_text = document.getElementById('filter_bay');
					filter_bay_text.focus();
					filter_bay_text.select();
				}
	...
	dat += {"
		...
		<table width='560' align='center' cellspacing='0' cellpadding='5' id='maintable'>
			...
			<tr id='search_tr'>
				<td align='center'>
					<b>Search:</b> <input type='text' id='filter_bay' value='' style='width:300px;'>
				</td>
			</tr>
	</table>
