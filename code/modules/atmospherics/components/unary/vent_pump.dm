...
/obj/machinery/atmospherics/unary/vent_pump/Initialize()
	...
	radio_filter_bay_in = frequency==1439?(RADIO_FROM_AIRALARM):null
	radio_filter_bay_out = frequency==1439?(RADIO_TO_AIRALARM):null
	if(frequency)
		radio_connection = register_radio(src, frequency, frequency, radio_filter_bay_in)
