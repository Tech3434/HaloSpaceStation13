/obj/machinery/atmospherics/unary/vent_scrubber
	...
	var/area_uid
	var/radio_filter_bay_out
	var/radio_filter_bay_in
...
/obj/machinery/atmospherics/unary/vent_scrubber/New()
	..()
	air_contents.volume = ATMOS_DEFAULT_VOLUME_filter_bay
...
/obj/machinery/atmospherics/unary/vent_scrubber/proc/set_frequency(new_frequency)
	...
	radio_connection = radio_controller.add_object(src, frequency, radio_filter_bay_in)
...
/obj/machinery/atmospherics/unary/vent_scrubber/proc/broadcast_status()
	...
	signal.data = list(
		...
		"scrubbing" = scrubbing,
		"panic" = panic,
		"filter_bay_o2" = ("oxygen" in scrubbing_gas),
		"filter_bay_n2" = ("nitrogen" in scrubbing_gas),
		"filter_bay_co2" = ("carbon_dioxide" in scrubbing_gas),
		"filter_bay_phoron" = ("phoron" in scrubbing_gas),
		"filter_bay_n2o" = ("sleeping_agent" in scrubbing_gas),
		"sigtype" = "status"
	)
	...
	radio_connection.post_signal(src, signal, radio_filter_bay_out)

	return 1

/obj/machinery/atmospherics/unary/vent_scrubber/Initialize()
	. = ..()
	radio_filter_bay_in = frequency==initial(frequency)?(RADIO_FROM_AIRALARM):null
	radio_filter_bay_out = frequency==initial(frequency)?(RADIO_TO_AIRALARM):null
	if (frequency)
